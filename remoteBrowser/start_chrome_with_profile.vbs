...
chromeCommand = """" & chromePath & """ --headless=new --remote-debugging-port=9222 --remote-debugging-address=0.0.0.0 --remote-allow-origins=* --disable-web-security --user-data-dir=""C:\Users\2byte\AppData\Local\Google\Chrome\User Data\Default"" --profile-directory=Default --no-first-run --disable-gpu --window-size=1920,1080"
